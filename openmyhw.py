...
def main():
    ...
    if(input1 == "5151"):                                                       #A specific string that opens your homework, put your own details in "" to run this for webwork courses: https://courses1.webwork.maa.org/webwork2
        ...
        driver.find_element_by_id("uname").send_keys("your username/email")                        #username/email
        driver.find_element_by_id("pswd").send_keys("your password")                         #password
        ...
        driver.find_element_by_id("email").send_keys("your username/email")
        driver.find_element_by_id("cengagePassword").send_keys("your password")
        ...
        driver.find_element_by_id("username").send_keys("your username/email")
